...
public class ApiTest {
	...
	public void testBuilderControllersApiSimple() {
		...
		// 服务地址
		config.setServerUrl("http://127.0.0.1:8080/asset-manage");
		// 生成到一个文档
...
//		config.isStrict();
		...
		config.setPackageFilters("com.oudot.med.erp.sys.controller.basearchives");
    ...
    public void testBuilderControllersApi() {
        ApiConfig config = new ApiConfig();
        config.setServerUrl("http://127.0.0.1:8080/online_reading");
        ...
        config.setPackageFilters("com.yyjj.reading.api.controller"
        	);
